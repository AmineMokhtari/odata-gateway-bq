<#
.SYNOPSIS
Builds and publishes the obq-hub Docker image to GCP Artifact Registry via Cloud Build.
...
.PARAMETER ImageName
Docker Image Name (default: obq-hub)

.PARAMETER Tag
Docker Image Tag (default: latest)

.EXAMPLE
.\publish.ps1 -p my-gcp-project -r us-central1 -repo my-docker-repo -i obq-hub -t latest
#>
param (
    [Alias("p", "project-id")]
